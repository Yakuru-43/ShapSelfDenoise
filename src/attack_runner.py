...
class AttackRunner:
    ...
    def run_attack(self):
        ...
        log_file_name = f"out/attack/{self.dataset_name}/{self.attack_name}/NoDefence/{model_precision}/dataset.csv"
        ...
        with open(f"out/attack/{self.dataset_name}/{self.attack_name}/NoDefence/{model_precision}/results.txt", "w") as f:
